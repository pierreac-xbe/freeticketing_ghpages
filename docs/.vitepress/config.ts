...
export default {
  title: "FreeTicketing",
  description:
    "FreeTicketing is a revolutionary eTicketing solution designed to streamline the submission and distribution of eTickets, enhancing efficiency and security in ticketing processes.",
  lang: "en-US",
  cleanUrls: true,
